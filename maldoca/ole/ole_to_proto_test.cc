...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        std::make_tuple("MALICIOUS_ffc835c9a950beda17fa79dd0acf28d1df3835232877b5fdd512b3df2ffb2431_xor_0x42_encoded",
...
TEST(OleToProtoTest, OleHwpSummaryInfo) {
  OleFile ole_file = GetOleProto(
      "MALICIOUS_7050af905f1696b2b8cdb4c6e6805a618addf5acfbd4edc3fc807a663016ab26_xor_0x42_encoded",
...
TEST(OleToProtoTest, OleNativeEmbedded) {
  OleFile ole_file = GetOleProto(
      "MALICIOUS_f674740dfdf4fd4ded529c339160c8255cdd971c4a00180c9e3fc3f3e7b53799_xor_0x42_encoded",
