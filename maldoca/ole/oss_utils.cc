...
bool BufferToUtf8::Init(const char* encode_name) {
  ...
  // Source: https://docs.microsoft.com/en-us/windows/win32/intl/code-page-identifiers
  static const absl::flat_hash_map<std::string, int> * name_to_code_map = [] {
    ...
    *map = {
      ...
      {"ibm01148", 1148},
      {"ibm01149", 1149},
      {"utf-16", kUtf16LECodePage},
      {"utf-16le", kUtf16LECodePage},
      {"unicodefffe", 1201},
      {"windows-1250", 1250},
      {"windows-1251", 1251},
      {"windows-1252", 1252},
  ...
  if (iter != name_to_code_map->end()) {
    ...
    init_success_ = true;
    DLOG(INFO) << "Using Windows code page: " << code_page_ << " for encoding: " << encode_name_lower;
    return true;
  } else {
    init_success_ = false;
